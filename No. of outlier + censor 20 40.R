...
xx= 0:numcol
plot(xx,Hbias,col=1,type="b",pch=21,ylim=c(-1*N,0.5*N),xlab = "No. of outliers",ylab ="bias*N")
...
legend("topright",x.intersp=1,y.intersp=0.2,pch=21:24,text.width=10,legend=c("Hbias(20%censor)","Pbias(20%censor)","Hbias(40%censor)","Pbias(40%censor)"),col=c(1,2,3,4),bty="n")
