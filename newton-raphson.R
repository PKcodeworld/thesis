...
Hellinger_optimize <-function(init){
 ...
 #   dDistance=function(t){
 #     dx=10^(-7)
 #     (Distance(t+dx)-Distance(t))/dx  
 #   }
    
    
 #   d2Distance=function(t){
 #     dx=10^(-7)
 #     (dDistance(t+dx)-dDistance(t))/dx  
 #   }
    
  #  b = newton(dDistance,d2Distance,b)
  }
  b
}
